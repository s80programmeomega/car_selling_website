    ...
    <div class="container">
        ...
        <div class="card p-medium">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($car->images->first())
                                    <img src="{{ asset('storage/' . $car->images->first()->image_path) }}" alt="" class="my-cars-img-thumbnail" />
                                @else
                                    <div class="my-cars-img-thumbnail" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white;">
                            ...
                            <td>
                                ...
                                <button wire:click="delete({{ $car->id }})" wire:confirm="Are you sure you want to delete this car?" class="btn btn-delete inline-flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 12px; margin-right: 5px">
            ...
            <nav class="pagination my-large">
                ...
                @else
                    <a href="{{ $cars->url(1) }}" wire:navigate class="pagination-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 18px">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m18.75 4.5-7.5 7.5 7.5 7.5m-6-15L5.25 12l7.5 7.5" />
                        </svg>
                    </a>
                ...
                @else
                    <a href="{{ $cars->previousPageUrl() }}" wire:navigate class="pagination-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 18px">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                        </svg>
                    </a>
                ...
                @foreach(range(1, $cars->lastPage()) as $page)
                    ...
                    @else
                        <a href="{{ $cars->url($page) }}" wire:navigate class="pagination-item">{{ $page }}</a>
                    @endif
                @endforeach

                @if($cars->hasMorePages())
                    <a href="{{ $cars->nextPageUrl() }}" wire:navigate class="pagination-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 18px">
                ...
                @else
                    <a href="{{ $cars->url($cars->lastPage()) }}" wire:navigate class="pagination-item">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 18px">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                        </svg>
                    </a>
        ...
        <div class="text-center py-12 px-6">
            <h3>No cars yet</h3>
            <p class="px-4">Start adding your cars to sell!</p>
