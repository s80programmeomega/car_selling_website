<div class="container-small">
    ...
    <form wire:submit.prevent="update" enctype="multipart/form-data" class="card add-new-car-form">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="number_of_owners"
        ...
        <div class="p-medium" style="width: 100%">
            <div class="flex justify-between">
                <button type="button" wire:click="delete" onclick="return confirm('Are you sure you want to delete this car?');" class="btn btn-danger">Delete Car</button>
